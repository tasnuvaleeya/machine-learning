...
J = (1/m) * sum(sum((-y_new) .* log(hypotheis) - (1- y_new) .* log(1 - hypotheis) ));
...
for t=1:m
  ...
  % Step 1
  a1 = X(t,:); % X has already a bias unit
  size(a1);
  a1 = a1' % 401 * 1
  z2 = Theta1 * a1;
  a2 = sigmoid(z2);
  ...
  a3 = sigmoid(z3); % Final activation layer a3 == h(theta) = sigmoid(z3)= (10 *1)
  
  % Step 2
  delta3 = a3 - y_new(:,t) % (10 *1)
  z2 = [1; z2]; % bias added (26 * 1)
  
  % Step 3
  delta2 = (Theta2' * delta3) .* sigmoidGradient(z2); % ((26, 10) * (10, 1)) =  (26 *1)
  
  % Step 4
  delta2 = delta2(2:end); % skipping sigma2(0) (25, 1)
